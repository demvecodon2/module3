...
insert into vi_tri (id_vi_tri, ten_vi_tri) values (1,'nhân viên'),
                                                  (2,'quản lý'),
                                                  (3,'đầu bếp ');
...
insert into trinh_do(id_trinh_do, trinh_do) values (1,'cấp 3'),
                                                   (2,'đại học'),
                                                   (3,'sư phạm');
...
insert into bo_phan(id_bo_phan, ten_bo_phan) values (1,'phục vụ');
insert into bo_phan(id_bo_phan, ten_bo_phan) values (2,'quản lý');
insert into bo_phan(id_bo_phan, ten_bo_phan) values (3,' bếp');
insert into bo_phan(id_bo_phan, ten_bo_phan) values (4,'lễ tân');
...
insert into loai_khach (id_loai_khach, ten_loai_khach) values (1,'newbie'),
                                                              (2,'silver'),
                                                              (3,'Platinium'),
                                                              (4,'Diamond');
...
insert into khach_hang(id_khach_hang, id_loai_khach, ho_ten, ngay_sinh, so_can_cuoc, so_dien_thoai, emai, dia_chi) VALUES
 (1,1,'hieu','1001-01-01','1231131','123-456-123','asjdqw@gmail.com','quảngtri'),
...
insert into kieu_thue(id_dang_thue, dang_thue, gia) VALUES (1,'villa','20500');
insert into kieu_thue(id_dang_thue, dang_thue, gia) VALUES (2,'House ','10000');
create table loai_dich_vu(
    id_loai_dich_vu int primary key auto_increment,
    ten_loai_dich_vu varchar(100)
);
insert into loai_dich_vu(id_loai_dich_vu, ten_loai_dich_vu) VALUES (1,'thực phẩm'),
                                                                   (2,'đồ uống'),
                                                                   (3,'giải trí');
...
id_loai_dich_vu, trang_thai) values (1,'nghỉ dưỡng','200','2','20','20000đ',1,1,'đang thuê'),
...
insert into hop_dong (id_nhan_vien, id_khach_hang, id_dich_vu, ngay_lam_hop_dong, ngay_ket_thuc, tien_dat_coc, tong_tien) VALUES
(1,1,1,'2024-12-11','2025-03-01','1000','20000'),
...
insert into di_vu_di_kem (id_dich_vu_di_kem, ten_dich_vu_di_kem, gia, don_vi, trang_thai_kha_dung) VALUES
(1,'thức uống','200','113','còn'),
...
SELECT id_khach_hang, id_loai_khach, ho_ten, ngay_sinh, so_can_cuoc, so_dien_thoai, emai, dia_chi
FROM khach_hang WHERE YEAR(ngay_sinh) >= 1997 AND dia_chi LIKE '%Quảng%';
